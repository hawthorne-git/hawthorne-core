...
class HawthorneCore::Email::SendEmailAddressUpdatePinJob < HawthorneCore::ApplicationJob
  ...
  def perform(user_id)
    ...
    HawthorneCore::Services::MailerSendSvc.send_email_address_update_verification_pin(user_site.user_id, user_site.new_email_address, user_site.new_email_address_pin_formatted)
