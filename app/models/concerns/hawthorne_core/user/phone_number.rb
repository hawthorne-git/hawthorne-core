...
module HawthorneCore::User::PhoneNumber
  ...
  included do
    ...
    def update_phone_number(phone_number:)
      new_sign_in_code_default_delivery = (phone_number.present? ? CODE_VIA_PHONE : CODE_VIA_EMAIL)
      update(phone_number:, sign_in_code_default_delivery: new_sign_in_code_default_delivery)
