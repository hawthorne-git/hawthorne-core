...
module HawthorneCore::Validation::Code
  ...
  included do
    ...
    def render_code_inactive_error(action: nil, note:, is_code_set:, is_code_expired:, are_max_attempts_reached:, refresh_attrs_then_send_it:, user_id: nil, from_magic_link: false)
    ...
    def render_code_not_match_error(action:, code:, code_to_match:, add_failed_attempt:, are_max_attempts_reached:, refresh_attrs_then_send_it:, user_id: nil, from_magic_link: false)
