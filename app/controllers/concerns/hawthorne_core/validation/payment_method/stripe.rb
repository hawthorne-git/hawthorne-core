...
module HawthorneCore::Validation::PaymentMethod::Stripe
  ...
  included do
    ...
    def redirect_on_invalid_stripe_payment_method_id(action:, payment_method_id:)
      ...
      HawthorneCore::UserAction::Log.add_credit_card_failure(failure_reason: HawthorneCore::UserAction::FailureReason.stripe_payment_method_invalid, note: { service: 'STRIPE', action:, payment_method_id: })
