...
class HawthorneCore::User::ProfileController < HawthorneCore::ApplicationController
  ...
  # if signed out ... the user is redirected to the sign-in page
  before_action :validate_signed_in?, only: [
    :email_address_update_show,
    :email_address_update_validation,
    :email_address_update_verify_pin,
    :email_address_update_verify_pin_show,
    :update,
    :show
  ]
  ...
  # validate the users email address, to update
  def email_address_update_validation
    ...
    # validate that the new email address does not have a syntax error
    ...
    # validate that the new email address does not match the current email address
    ...
    # validate that the new email address is not taken
  ...
  def email_address_update_verify_pin_show
  ...
  def email_address_update_verify_pin
