...
--
-- Name: products products_product_types_product_type_id_fk; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.products
    ADD CONSTRAINT products_product_types_product_type_id_fk FOREIGN KEY (product_type_id) REFERENCES public.product_types(product_type_id);
